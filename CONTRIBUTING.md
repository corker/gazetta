...
Look for issues labeled [`good first issue`](https://github.com/corker/gazetta/labels/good%20first%20issue).
...
- **Questions**: use [GitHub Discussions](https://github.com/corker/gazetta/discussions)
